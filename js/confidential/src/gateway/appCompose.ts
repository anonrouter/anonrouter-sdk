...
// RTMR3 as the "compose-hash" event. Because it is measured, everything inside it
// is a hardware-backed fact about the running deployment, including the full
...
import { sha256Hex } from "../verify/crypto.js";
